...
class DB {
    ...
    _deleteOlderRange(req) {
        ...
        // taable directly; This is just for prototyping purposes, a proper abstraction for
        // timeline access will be needed.
        const reqTid = req.query.attributes.tid;
        const delTid = TimeUuid.fromDate(new Date(reqTid.getDate().getTime() - 86400000));
        ...
        .then((res) => {
            if (res.rows.length !== 1) {
                this.log(
                    ...
                    'no timeline results were returned');
                return P.resolve();
            }
